...
def dfa(prg):
    ...
    def runOnFunction(cfg, init, merge, transfer):
    ...
    for func in funcs:
        ...
        if "args" in func:
            for idx, arg in enumerate(func["args"]):
                ...
                init_def.add(def_id)
        in_b, out_b = runOnFunction(name2block,
                                    init_def,
...
if __name__ == "__main__":
    ...
    parser.add_argument('-reach_def', dest='reach_def', action='store_true', help='multiple runs')
